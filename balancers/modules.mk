...
mod_lbmethod_roundrobin.la: mod_lbmethod_roundrobin.slo
	$(SH_LINK) -rpath $(libexecdir) -module -avoid-version  mod_lbmethod_roundrobin.lo $(MOD_LBMETHOD_ROUNDROBIN_LDADD)
DISTCLEAN_TARGETS = modules.mk
static = 
shared =  mod_lbmethod_byrequests.la mod_lbmethod_bytraffic.la mod_lbmethod_bybusyness.la mod_lbmethod_heartbeat.la mod_lbmethod_roundrobin.la
